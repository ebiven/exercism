...
defmodule ForthTest do
  ...
  test "defining words with odd characters" do
    s = Forth.new
        #TODO: This wasn't in the instructions, and I was farther down
        # the road than I care to re-travel to be able to support
        # multi-statement evals, not to mention that isn't the stated
